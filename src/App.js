...
function App() {
  ...
  const addToList = () => {
    Axios.post('http://localhost:8000/insert', { name: name, rollnumber: rollnumber })
      .then((response) => {
  ...
  const handleUpdateAttendance = () => {
    ...
    Axios.post('http://localhost:8000/attendance', { attendanceData: attendanceArray })
      .then(() => {
  ...
  const handleDownloadAttendance = () => {
    Axios.get('http://localhost:8000/download', { responseType: 'blob' })
      .then((response) => {
